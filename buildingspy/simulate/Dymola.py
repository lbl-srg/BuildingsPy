...
// Do not edit.
_curDir = Modelica.Utilities.System.getWorkDirectory();
Modelica.Utilities.System.setWorkDirectory("{packagePath}");
Modelica.Utilities.Files.remove("{log_file}");
// Change to working directory and read the .mo file from there
openModel("package.mo");
Modelica.Utilities.System.setWorkDirectory(_curDir);
OutputCPUtime:=true;
""".format(packagePath=self._packagePath,
           log_file=log_file)
