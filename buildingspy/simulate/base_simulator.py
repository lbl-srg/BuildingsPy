...
# self._time_stamp_old_files = None
    ...
    def setPackagePath(self, packagePath):
        ...
        if not found:
            msg = f"Argument packagePath={
                packagePath} must be a directory containing either package.mo or package.moe."
                ...
                if self._MODELICA_EXE == 'dmc' or self._MODELICA_EXE == 'dymola':
                    ...
                    while not terminatedProcess and not killedProcess:
                        ...
                        if elapsedTime > terminate_timeout:
                            ...
                            pro.kill()
                            killedProcess = True
                    em = f"Process timeout: terminated process as it computed longer than {
                        str(timeout)} seconds."
