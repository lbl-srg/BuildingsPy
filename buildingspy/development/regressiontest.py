            ...
            if checkroot:
                ...
                for path in paths:
                    if path.endswith('.mo') and not path.endswith('package.mo'):
                        ...
                        if 'BuildingsPy.build.lib.buildingspy.tests.MyModelicaLibrary' not in ful_nam:
                            # This test excludes files generated by travis, see
                            # https://travis-ci.com/github/lbl-srg/BuildingsPy/jobs/326298170#L924
                            res.append(ful_nam)
        return res
